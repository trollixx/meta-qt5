...
QMAKESPEC = "${QMAKE_MKSPEC_PATH_NATIVE}/${OE_QMAKE_PLATFORM_NATIVE}"

QMAKE_MKSPEC_PATH = "${STAGING_DATADIR}/${QT_DIR_NAME}/mkspecs"
OE_QMAKE_PLATFORM = "${TARGET_OS}-oe-g++"
XQMAKESPEC = "${QMAKE_MKSPEC_PATH}/${OE_QMAKE_PLATFORM}"
...
export OE_QMAKE_SYNCQT = "${STAGING_BINDIR_NATIVE}/${QT_DIR_NAME}/syncqt"
